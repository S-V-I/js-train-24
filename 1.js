...
function task1() {
   ...
   *
   *  data - вхідні дані.
   *  timeout - час в мілісекундах, який витрачається на отримання даних,
   *  за замовчуванням 2000мс.
   */
  function getData(data, timeout = 2000) {
    ...
    // Якщо об'єкт пустий, ми викликаємо reject з новим
    // об'єктом Error("Об'єкт пустий")
